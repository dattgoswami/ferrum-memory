...
Serves [forge-agent](https://github.com/ferrum/forge-agent), [agent-runtime](https://github.com/ferrum/agent-runtime), and [ferrum-evals](https://github.com/ferrum/ferrum-evals). Unlike a general vector DB, ferrum-memory is a **continual learning instrument**: storing RL experience tuples (task, tool_calls, test_result, reward) and implementing prioritized experience replay (PER) for the dream cycle.
